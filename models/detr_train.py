...
class DetrCocoDataset(torchvision.datasets.CocoDetection):
    def __init__(self, img_folder, feature_extractor, train=True):
        ann_file = os.path.join(img_folder, "annotations_coco.json")
...
def run_training(data_dir, epochs, batch_size, lr, lr_backbone, weight_decay, checkpoint_path=None):
    ...
    train_folder = os.path.join(data_dir, "train","images")
    val_folder = os.path.join(data_dir, "val","images")
    ...
    trainer.save_checkpoint("detr_model_first.ckpt")
