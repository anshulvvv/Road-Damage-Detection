...
def create_custom_config(data_root, batch_size, epochs):
    ...
    HOME = os.getcwd()
    config_dir = os.path.join(HOME, "mmyolo" ,"configs", "rtmdet")
...
train_ann_file = "train/images/annotations_coco.json"
train_data_prefix = "train/images"

val_ann_file = "val/images/annotations_coco.json"
...
def train_model(custom_config_path , new ,resume_checkpoint=None):
    ...
    # # Call the MMDetection training script.
    # if(new) : 
    #     train_cmd = f"/home/ansul/AI_Road_Health_Assessment/models/mmyolo/tools/train.py /home/ansul/AI_Road_Health_Assessment/models/mmyolo/configs/rtmdet/custom.py"
    #     print("Starting training with command:", train_cmd)
    #     os.system(train_cmd)
    # else :
    #     train_cmd = f"/home/ansul/AI_Road_Health_Assessment/models/mmyolo/tools/train.py /home/ansul/AI_Road_Health_Assessment/models/mmyolo/configs/rtmdet/custom.py --resume-from {resume_checkpoint}"
    #     print("Resuming training with command:", train_cmd)
    #     os.system(train_cmd)
    if new:
        command = [
            "/home/ansul/rtm-env/bin/python",
            "/home/ansul/AI_Road_Health_Assessment/models/mmyolo/tools/train.py",
            "/home/ansul/AI_Road_Health_Assessment/models/mmyolo/configs/rtmdet/custom.py"
        ]
        print("Starting training with command:", " ".join(command))
        ...
        print("Resuming training with command:", " ".join(command))
        result = subprocess.run(command, capture_output=True, text=True)
        print(result.stdout)
        print(result.stderr)
    with open("/home/ansul/AI_Road_Health_Assessment/models/work_dirs/custom/last_checkpoint", "r") as f:
        line = f.read().strip()
    tokens = line.split()
    checkpoint_path = tokens[0]
...
if __name__ == "__main__":
    args = parse_args()
    res1,res2 = run_training_and_inference(
    ...
    output_data = {"checkpoint_path": res1, "config_path": res2}
